  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className={`flex-1 flex flex-col items-center ${user && user.role !== 'admin' && scheduledWalks.length > 0 && timelineVisible ? 'md:pr-[320px]' : ''} transition-all duration-300`}>
        ...
        {/* Mission Statement */}
        <div className="w-full bg-gradient-to-b from-white to-red-50 py-20">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-zinc-900">Make a Difference</h3>
                      <p className="text-zinc-600">Every walk brings joy and essential exercise to shelter dogs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-zinc-900">Simple Process</h3>
                      <p className="text-zinc-600">Sign up, complete a waiver, and start making a difference today.</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <Link to="/walk" className="text-red-700 font-semibold hover:text-red-900 text-decoration-none">
                    Schedule a Walk →
                  </Link>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <Link to="/adoption" className="text-red-700 font-semibold hover:text-red-900 text-decoration-none">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <Link to="/donation" className="text-red-700 font-semibold hover:text-red-900 text-decoration-none">
                    Make a Donation →
                  </Link>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Testimonial 1 */}
            <div className="bg-zinc-50 p-6 rounded-lg shadow border border-zinc-200">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-600">Regular Walker</p>
                </div>
              </div>
            ...
            <div className="bg-zinc-50 p-6 rounded-lg shadow border border-zinc-200">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-600">Adopter</p>
                </div>
              </div>
              <p className="italic text-zinc-700">
            ...
            <div className="bg-zinc-50 p-6 rounded-lg shadow border border-zinc-200">
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-zinc-600">Marshall</p>
                </div>
              </div>
              <p className="italic text-zinc-700">
        ...
        <div className="w-full bg-red-900 py-12 mb-16 mx-4 md:mx-8 rounded-xl"> {/* Added mx-4 md:mx-8 and rounded-xl */}
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/login" className="bg-white text-red-900 hover:bg-zinc-200 font-bold py-3 px-8 rounded-full text-lg text-decoration-none">
                Sign Up Today
              </Link>
      ...
      {user && user.role !== 'admin' && scheduledWalks.length > 0 && (
        <div 
          className={`hidden md:block fixed right-0 top-0 bottom-0 w-[300px] bg-red-50 p-4 overflow-y-auto shadow-lg z-10 transform transition-transform duration-300 ease-in-out ${
            timelineVisible ? 'translate-x-0' : 'translate-x-full'
          }`}
        >
          <div className="sticky top-0 bg-red-50 pb-2 pt-2 z-20">
            <h2 className="text-xl font-bold text-red-900 border-b-2 border-red-200 pb-2">Your Upcoming Walks</h2>
          </div>
          
          <div className="mt-4 relative">
            {/* Timeline Line */}
            <div className="absolute left-4 top-0 bottom-0 w-0.5 bg-red-400"></div>
      ...
      {user && user.role !== 'admin' && scheduledWalks.length > 0 && (
        <div className="md:hidden w-full bg-red-50 p-4 mt-6">
